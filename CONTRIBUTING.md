...
If you find a bug, please [create an issue](https://github.com/tommycrusher/smart-ai/issues) to report it! A great bug
report includes:
...
- Create an issue
  ...
  - If not, [create an issue](https://github.com/tommycrusher/smart-ai/issues)
  - Please describe the enhancement in as much detail as you can, and why it would be useful

- Join the [GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) and tell us about your idea
...
- **For new features**: Include a short screen recording or screenshot demonstrating the new functionality. This makes it much easier for us as contributors to review and understand your changes. See [this PR](https://github.com/tommycrusher/smart-ai/pull/6455) as a good example
...
Join the [GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) to engage with maintainers and other contributors.
