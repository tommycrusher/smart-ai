...
export class JiraClient {
  ...
  async listIssues(
    ...
    if (response.status === 500) {
      ...
      console.warn(
        "Unable to get Jira tickets. You may need to set 'apiVersion': 2 in your config.json. See full documentation here: https://docs.smart-ai.dev/customize/context-providers#jira-datacenter-support\n\n",
        text,
      );
