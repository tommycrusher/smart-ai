...
class DatabaseContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The database context provider is deprecated and may be removed in a later version. Please consider using a database MCP server like postgres-mcp (https://smart-ai.dev/anthropic/postgres-mcp) instead.";
  }
