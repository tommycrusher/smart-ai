...
class GitLabMergeRequestContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The Gitlab Merge Request context provider is now deprecated and will be removed in a later version. Please consider using the GitLab MCP (https://smart-ai.dev/docker/mcp-gitlab) instead.";
  }
