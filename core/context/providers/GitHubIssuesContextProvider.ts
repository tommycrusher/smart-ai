...
class GitHubIssuesContextProvider extends BaseContextProvider {
  ...
  get deprecationMessage() {
    return "The GitHub issues context provider is now deprecated and will be removed in a later version. Please consider using the GitHub MCP server (https://smart-ai.dev/anthropic/github-mcp) instead.";
  }
