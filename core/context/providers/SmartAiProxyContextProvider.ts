...
class SmartAiProxyContextProvider extends BaseContextProvider {
  ...
  override get description(): ContextProviderDescription {
    return {
      title:
        this.options.title || SmartAiProxyContextProvider.description.title,
      displayTitle:
        this.options.displayTitle ||
        this.options.name ||
        SmartAiProxyContextProvider.description.displayTitle,
      description:
        this.options.description ||
        SmartAiProxyContextProvider.description.description,
      type: this.options.type || SmartAiProxyContextProvider.description.type,
    };
  }
...
export default SmartAiProxyContextProvider;
