...
describe("SmartAiProxy", () => {
  afterEach(() => {
    vi.clearAllMocks();
  });

  test("rerank should send a valid request", async () => {
    const proxy = new SmartAiProxy({
      apiKey: "test-api-key",
      model: "test-model",
      apiBase: "https://proxy.smart-ai.dev/model-proxy/v1/",
    });
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.smart-ai.dev/model-proxy/v1/rerank",
        method: "POST",
        headers: {
  ...
  test("streamChat should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.smart-ai.dev/model-proxy/v1/chat/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("streamFim should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.smart-ai.dev/model-proxy/v1/fim/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  test("embed should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.smart-ai.dev/model-proxy/v1/embeddings",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("listModels should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      params: [],
      expectedRequest: {
        url: "https://proxy.smart-ai.dev/model-proxy/v1/models",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
