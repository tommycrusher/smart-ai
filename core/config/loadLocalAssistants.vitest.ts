...
describe("ASSISTANTS getAllDotContinueDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    ...
    addToTestDir([
      ".smart-ai/assistants/",
      [".smart-ai/assistants/assistant1.yaml", "yaml content 1"],
      [".smart-ai/assistants/assistant2.yml", "yaml content 2"],
      [".smart-ai/assistants/assistant3.md", "markdown content 1"],
      [".smart-ai/assistants/assistant4.txt", "txt content"],
      [".smart-ai/assistants/config.yaml", "txt content"],
      [".smart-ai/assistants/config.yml", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".smart-ai/assistants/",
      [".smart-ai/assistants/nonmatch1.txt", "txt content"],
      [".smart-ai/assistants/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    addToTestDir([
      [".smart-ai/assistants/assistant5.YAML", "uppercase yaml"],
      [".smart-ai/assistants/assistant6.YML", "uppercase yml"],
      [".smart-ai/assistants/assistant7.MD", "uppercase md"],
    ]);
...
describe("AGENTS getAllDotContinueDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    ...
    addToTestDir([
      ".smart-ai/agents/",
      [".smart-ai/agents/agent1.yaml", "yaml content 1"],
      [".smart-ai/agents/agent2.yml", "yaml content 2"],
      [".smart-ai/agents/agent3.md", "markdown content 1"],
      [".smart-ai/agents/agent4.txt", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".smart-ai/agents/",
      [".smart-ai/agents/nonmatch1.txt", "txt content"],
      [".smart-ai/agents/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    // Add files with uppercase extensions
    addToTestDir([
      [".smart-ai/agents/agent5.YAML", "uppercase yaml"],
      [".smart-ai/agents/agent6.YML", "uppercase yml"],
      [".smart-ai/agents/agent7.MD", "uppercase md"],
    ]);
