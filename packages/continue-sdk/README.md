...
This SDK provides programmatic access to Smart AI's Hub APIs and functionality.

## Overview

The Smart AI SDK is structured into separate language-specific packages, currently with implementations for TypeScript and Python, with more languages planned for the future:
...
1. OpenAPI-generated clients for the Smart AI Hub API
2. A wrapper layer that exposes a `Smart AI.from()` method to easily initialize and use Smart AI assistants with an OpenAI-compatible interface
