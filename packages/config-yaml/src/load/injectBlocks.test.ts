...
schema: v1
rules:
  - "Input: \${{ inputs.userSetting }} | Secret: \${{ secrets.apiKey }} | Smart AI: \${{ smartai.workspaceRoot }}"
`;
    ...
    expect(ruleText).toBe(
      "Input: ${{ secrets.//userSetting }} | Secret: ${{ secrets.//apiKey }} | Smart AI: ${{ smartai.workspaceRoot }}",
    );
    ...
    expect(configStr).toContain("smartai.workspaceRoot");
  });
