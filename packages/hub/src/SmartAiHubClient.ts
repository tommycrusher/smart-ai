...
import { ISmartAiHubClient } from "./ISmartAiHubClient.js";

interface SmartAiHubClientOptions {
  apiKey?: string;
  apiBase?: string;
  fetchOptions?: RequestInit;
}

export class SmartAiHubClient implements ISmartAiHubClient {
  private readonly apiKey?: string;
  private readonly apiBase: string;
  private readonly fetchOptions?: RequestInit;

  constructor(options: SmartAiHubClientOptions) {
    this.apiKey = options.apiKey;
    this.apiBase = options.apiBase ?? "https://api.smart-ai.dev";
