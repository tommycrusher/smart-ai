    ...
    return (
      <div className="flex items-center gap-2 italic">
        ...
        <span className="leading-relaxed">
          ...
          examples:
          <a
            href="https://docs.smart-ai.dev/walkthroughs/codebase-embeddings#embeddings-providers"
            target="_blank"
            className="cursor-pointer text-inherit underline hover:text-inherit"
          >
            https://docs.smart-ai.dev/walkthroughs/codebase-embeddings#embeddings-providers
          </a>
        </span>
      </div>
    );
