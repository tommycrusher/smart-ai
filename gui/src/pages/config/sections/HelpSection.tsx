...
const vscodeShortcuts: Omit<KeyboardShortcutProps, "isEven">[] = [
  ...
  },
  {
    shortcut: "cmd L",
    description:
      "New Chat / New Chat With Selected Code / Close Smart AI Sidebar If Chat Already In Focus",
  },
  {
  ...
  },
  {
    ...
    description:
      "Focus Current Chat / Add Selected Code To Current Chat / Close Smart AI Sidebar If Chat Already In Focus",
  },
  {
        ...
        <div>
          ...
          <Card className="!p-0">
            <div className="flex flex-col">
              <ConfigRow
                title="Documentation"
                description="Learn how to configure and use Smart AI"
                icon={LinkIcon}
                onClick={() =>
                  ideMessenger.post("openUrl", "https://docs.smart-ai.dev/")
                }
              />
              ...
              <ConfigRow
                ...
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://github.com/tommycrusher/smart-ai/issues/new/choose",
                  )
                }
              />
              ...
              <ConfigRow
                ...
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://github.com/tommycrusher/smart-ai/discussions",
                  )
                }
              />
            </div>
