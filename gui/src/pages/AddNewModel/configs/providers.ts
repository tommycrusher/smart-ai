...
export const providers: Partial<Record<string, ProviderInfo>> = {
  ...
  moonshot: {
    ...
    longDescription: `[Visit our documentation](https://docs.smart-ai.dev/reference/Model%20Providers/moonshot) for information on obtaining an API key.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://docs.smart-ai.dev/reference/Model%20Providers/azure) for information on obtaining an API key.
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
  ...
  lemonade: {
    ...
    longDescription:
      "Lemonade provides optimized local LLM inference with support for AMD NPU, GPU, and CPU acceleration. Visit [lemonade-server.ai](https://lemonade-server.ai/) for installation and setup instructions. Once the Lemonade server is running, you can begin using Smart AI with your local models.",
    icon: "lemonade.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    params: {
...
After it's up and running, you can start using Smart AI.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
