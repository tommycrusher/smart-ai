...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "smartai.diffVisible", true);
  ...
  async streamEdit({
    ...
    if (existingHandler) {
      ...
      // but extra delta was added for each line generated by Smart AI
      // Before adding this back, we need to distinguish between human and Smart AI
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("smartai.rejectDiff");
      }
