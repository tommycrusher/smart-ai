...
import { SmartAiCompletionProvider } from "../completionProvider";
...
describe("SmartAiCompletionProvider triggering logic", () => {
...
function buildProvider(options: { usingFullFileDiff?: boolean } = {}) {
  ...
  const provider = new SmartAiCompletionProvider(
    configHandler,
    ide,
    webviewProtocol,
    usingFullFileDiff,
