    ...
    quickPick.onDidAccept(async () => {
      ...
      switch (label) {
        case UserPromptLabels.AcceptAll:
          vscode.commands.executeCommand("smartai.acceptDiff", path);
          break;
        case UserPromptLabels.RejectAll:
          vscode.commands.executeCommand("smartai.rejectDiff", path);
          break;
        case QuickEditInitialItemLabels.Submit:
          if (quickPick.value) {
            await vscode.commands.executeCommand("smartai.rejectDiff", path);
