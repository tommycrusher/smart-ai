# End-to-End Testing for Smart AI CLI

This document describes the principles, practices, and patterns for writing end-to-end (E2E) tests for the Smart AI CLI.
