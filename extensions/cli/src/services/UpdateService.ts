...
export class UpdateService extends BaseService<UpdateServiceState> {
  ...
  private async checkAndAutoUpdate() {
    ...
    try {
      ...
      if (
        ...
        this.setState({
          ...
          message: isUpdateAvailable
            ...
            : `Smart AI CLI v${this.currentState.currentVersion}`,
          isUpdateAvailable,
          latestVersion,
        });
      }
      ...
      this.setState({
        ...
        message: `Smart AI CLI v${this.currentState.currentVersion}`,
        error,
      });
    }
  }
  ...
  async performUpdate(isAutoUpdate?: boolean) {
    ...
    try {
      ...
      // Install the update
      const { stdout, stderr } = await execAsync("npm i -g @smartai/cli");
