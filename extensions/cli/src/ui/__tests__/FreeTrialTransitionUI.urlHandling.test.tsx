...
describe("FreeTrialTransitionUI - URL Opening Security", () => {
  ...
  it("should verify URL format for models setup", () => {
    ...
    const baseUrl = "https://test.smart-ai.dev";
    const expectedUrl = new URL("setup-models", baseUrl).toString();

    expect(expectedUrl).toBe("https://test.smart-ai.dev/setup-models");
  });
  ...
  it("should handle URL construction with different base URLs", () => {
    ...
    const testCases = [
      {
        base: "https://smart-ai.dev",
        expected: "https://smart-ai.dev/setup-models",
      },
      {
        base: "https://app.smart-ai.dev",
        expected: "https://app.smart-ai.dev/setup-models",
      },
      {
