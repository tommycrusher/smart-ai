...
import com.github.smartai.smartaiintellijextension.browser.SmartAiBrowser
import com.github.smartai.smartaiintellijextension.browser.SmartAiBrowser.Companion.buildChunkScripts
import junit.framework.TestCase
import java.util.Base64

class SmartAiBrowserChunkTest : TestCase() {
    ...
    fun `test message splits into expected number of chunks`() {
        ...
        val chunkSize = SmartAiBrowser.CHUNK_SIZE
