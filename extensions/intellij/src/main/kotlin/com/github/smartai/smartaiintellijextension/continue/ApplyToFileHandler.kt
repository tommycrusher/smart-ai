...
import com.github.smartai.smartaiintellijextension.ApplyState
import com.github.smartai.smartaiintellijextension.ApplyStateStatus
import com.github.smartai.smartaiintellijextension.IDE
import com.github.smartai.smartaiintellijextension.ToastType
import com.github.smartai.smartaiintellijextension.browser.SmartAiBrowserService.Companion.getBrowser
import com.github.smartai.smartaiintellijextension.editor.DiffStreamHandler
...
import com.github.smartai.smartaiintellijextension.protocol.ApplyToFileParams
...
class ApplyToFileHandler(
    ...
    companion object {
         ...
         */
        suspend fun apply(
            project: Project, continuePluginService: SmartAiPluginService, ide: IDE, params: ApplyToFileParams
        ) {
            val editorUtils =
