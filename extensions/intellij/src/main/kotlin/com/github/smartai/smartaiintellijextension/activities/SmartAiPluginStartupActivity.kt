package com.github.smartai.smartaiintellijextension.activities

import com.intellij.openapi.fileEditor.FileEditorManagerListener
import com.github.smartai.smartaiintellijextension.auth.AuthListener
import com.github.smartai.smartaiintellijextension.auth.SmartAiAuthService
import com.github.smartai.smartaiintellijextension.auth.ControlPlaneSessionInfo
...
import com.github.smartai.smartaiintellijextension.`continue`.*
import com.github.smartai.smartaiintellijextension.listeners.SmartAiPluginSelectionListener
import com.github.smartai.smartaiintellijextension.services.ContinueExtensionSettings
import com.github.smartai.smartaiintellijextension.services.SmartAiPluginService
import com.github.smartai.smartaiintellijextension.services.SettingsListener
import com.github.smartai.smartaiintellijextension.utils.toUriOrNull
...
fun showTutorial(project: Project) {
    ...
    SmartAiPluginStartupActivity::class.java.getClassLoader().getResourceAsStream(tutorialFileName)
        .use { `is` ->
            if (`is` == null) {
...
private fun getTutorialFileName(): String {
    ...
    return when {
        appName.contains("intellij") -> "smartai_tutorial.java"
        appName.contains("pycharm") -> "smartai_tutorial.py"
        appName.contains("webstorm") -> "smartai_tutorial.ts"
        else -> "smartai_tutorial.py" // Default to Python tutorial
    }
}

class SmartAiPluginStartupActivity : StartupActivity, DumbAware {
    ...
    private fun initializePlugin(project: Project) {
        ...
        val continuePluginService = project.service<SmartAiPluginService>()
        ...
        coroutineScope.launch {
            ...
            val authService = service<SmartAiAuthService>()
            ...
            val listener =
                SmartAiPluginSelectionListener(
                    coroutineScope,
                )
            ...
            EditorFactory.getInstance().eventMulticaster.addSelectionListener(
                listener,
                project.service<SmartAiPluginDisposable>()
            )
