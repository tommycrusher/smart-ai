...
import com.github.smartai.smartaiintellijextension.*
import com.github.smartai.smartaiintellijextension.activities.SmartAiPluginDisposable
import com.github.smartai.smartaiintellijextension.activities.showTutorial
...
import com.github.smartai.smartaiintellijextension.error.SmartAiSentryService
import com.github.smartai.smartaiintellijextension.protocol.*
...
import com.github.smartai.smartaiintellijextension.utils.getMachineUniqueID
...
class IdeProtocolClient(
    private val continuePluginService: SmartAiPluginService,
     ...
     *
     * See this thread for details: https://github.com/smartai/continue/issues/4098#issuecomment-2854865310
     */
    ...
    fun handleMessage(msg: String, respond: (Any?) -> Unit) {
        coroutineScope.launch(limitedDispatcher) {
            ...
            try {
                ...
                service<SmartAiSentryService>().report(exception, exceptionMessage)
