...
class SmartAiProcessHandler(
    parentScope: CoroutineScope,
    private val process: SmartAiProcess,
    ...
    private val log = Logger.getInstance(SmartAiProcessHandler::class.java)
                ...
                while (isActive) {
                    ...
                    if (line != null && line.isNotEmpty()) {
                        try {
                            ...
                            service<SmartAiSentryService>().report(e, "Error handling message: $line")
                        }
                    } else
                        delay(100)
                }
            } catch (e: IOException) {
                service<SmartAiSentryService>().report(e)
            }
        }
        scope.launch(Dispatchers.IO) {
