...
@Service
class SmartAiSentryService(
    private val telemetryStatus: SmartAiTelemetryStatus = service<SmartAiTelemetryStatusService>()
) {
    private val log = Logger.getInstance(SmartAiSentryService::class.java.simpleName)
    ...
    private companion object {
        private const val PLUGIN_ID = "com.github.smartai.smartaiintellijextension"
