...
import com.github.smartai.smartaiintellijextension.constants.ContinueConstants
import com.github.smartai.smartaiintellijextension.constants.getContinueGlobalPath
import com.github.smartai.smartaiintellijextension.`continue`.file.FileUtils
...
import com.github.smartai.smartaiintellijextension.utils.*
...
class IntelliJIDE(
    ...
    private val ADDITIONAL_SEARCH_IGNORE_FILETYPES = listOf(
        ...
        "*.gcno", "go.sum", "*.gitignore", "*.gitkeep", "*.smartaiignore",
    ...
    override suspend fun getFileResults(pattern: String, maxResults: Int?): List<String> {
        ...
        if (ideInfo.remoteName == "local") {
            try {
                ...
                service<SmartAiSentryService>().report(exception, message)
