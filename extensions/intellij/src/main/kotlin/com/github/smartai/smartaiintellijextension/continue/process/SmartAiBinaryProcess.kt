...
import com.github.smartai.smartaiintellijextension.error.SmartAiPostHogService
import com.github.smartai.smartaiintellijextension.error.SmartAiSentryService
import com.github.smartai.smartaiintellijextension.proxy.ProxySettings
import com.github.smartai.smartaiintellijextension.utils.OS
import com.github.smartai.smartaiintellijextension.utils.getContinueBinaryPath
import com.github.smartai.smartaiintellijextension.utils.getOS
...
class SmartAiBinaryProcess(
    ...
    private fun reportErrorTelemetry() {
        ...
        service<SmartAiSentryService>().reportMessage("Core process exited with output: $err")
        service<SmartAiPostHogService>().capture("jetbrains_core_exit", mapOf("error" to err))
    }
