package com.github.smartai.smartaiintellijextension.nextEdit
...
class ContinueNextEditService(private val project: Project) : NextEditService {
    ...
    private val coreMessenger: CoreMessenger?
        get() = project.service<SmartAiPluginService>().coreMessenger
...
//                val nextEditItem = processedItem?.let { convertToNextEditItem(it) }
    ...
    private fun parseProcessedItem(response: Any?): ProcessedItem? {
        return try {
            ...
            val range = com.github.smartai.smartaiintellijextension.Range(startPosition, endPosition)
            val location = com.github.smartai.smartaiintellijextension.RangeInFile(filepath, range)
