...
Type `/check` in your coding agent. It discovers every check file in `.smart-ai/checks/`, runs each one as a sub-agent against your current branch, and reports the results.
