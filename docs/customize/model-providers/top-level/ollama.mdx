---
title: "How to Configure Ollama with Smart AI"
slug: ../ollama
sidebarTitle: "Ollama"
---

<Tip>
  **Discover Ollama models [here](https://smart-ai.dev/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://smart-ai.dev/ollama/qwen3-coder-30b?view=config)**
</Info>
...
Smart AI may set a higher default context length than other Ollama tools, causing this error even when the model works elsewhere. Fix by reducing `contextLength`:
