---
title: "How to Configure OpenRouter with Smart AI"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](https://smart-ai.dev/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://smart-ai.dev/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  Smart AI automatically uses system message tools for models that don't support
