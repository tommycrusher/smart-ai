...
<Tip>
  **Discover LM Studio models [here](https://smart-ai.dev/lmstudio)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://smart-ai.dev/lmstudio/qwen-qwen3-coder-30b?view=config)**
</Info>