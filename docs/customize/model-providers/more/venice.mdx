---
title: "Venice AI"
description: "Configure Venice AI with Smart AI to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.smart-ai/config.json` to look like the following.
