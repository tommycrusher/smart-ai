---
title: "Kindo"
description: "Configure Kindo with Smart AI to centralize control over your organization's AI operations with support for commercial and open-source models while ensuring data protection and policy compliance"
---
