---
title: "SiliconFlow"
description: "Configure SiliconFlow with Smart AI to access their AI model platform, featuring Qwen's Coder models for chat and autocomplete, along with various embedding and reranking models"
---
