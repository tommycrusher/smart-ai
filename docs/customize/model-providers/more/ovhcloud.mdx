---
title: "OVHcloud"
description: "Configure OVHcloud AI Endpoints with Smart AI to access their GDPR-compliant serverless inference API for models like Qwen, Llama, Mistral, and Deepseek, with strong security and data privacy features"
---
...
Function calling is automatically enabled for supported models when using Smart AI.
