---
title: "Nebius"
description: "Configure Nebius AI Studio with Smart AI to access their language model offerings, including DeepSeek R1 for chat and BAAI embeddings models"
---
