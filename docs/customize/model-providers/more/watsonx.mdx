---
title: "IBM WatsonX"
description: "How to configure IBM's watsonx models in Smart AI, including authentication methods, deployment options, and support for chat, autocomplete, embeddings, and reranking models"
---
...
To authenticate to watsonx.ai SaaS with Smart AI, you will need to create a project and [set up an API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key). Then, in continue:
...
To authenticate to your watsonx.ai Software instance with Smart AI, you can use either `username/password` or `ZenApiKey` method:
