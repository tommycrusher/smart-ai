...
description: "Configure Text Generation WebUI with Smart AI to use its comprehensive open-source language model UI and local server through its OpenAI-compatible API"
---
