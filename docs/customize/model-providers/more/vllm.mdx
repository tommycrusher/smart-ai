---
title: "vLLM"
description: "Configure vLLM's high-performance inference library with Smart AI for chat, autocomplete, and embeddings, including setup instructions for Llama3.1, Qwen2.5-Coder, and Nomic Embed models"
---
...
Smart AI automatically handles vLLM's response format (which uses `results` instead of `data`).
