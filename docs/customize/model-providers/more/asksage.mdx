...
<Tip>
  **Discover Ask Sage models [here](https://smart-ai.dev/hub?q=Ask%20Sage)**
</Tip>
...
Add your Ask Sage model to your Smart AI configuration file, which is located at `~/.smart-ai/config.yaml`. If it does not exist, create it.
...
- Restart Smart AI to apply changes.

Your Ask Sage model will now be available in Smart AI.
...
## Setting up Smart AI CLI

1. Install Smart AI CLI
Follow the steps from the [official Smart AI docs](https://docs.smart-ai.dev/cli/quickstart).

2. Setting up a custom config for Ask Sage
Follow the steps in step 2 of the Overview above 👆.

3. How to use Smart AI CLI
Use [Smart AI's official guide](https://docs.smart-ai.dev/guides/cli).
