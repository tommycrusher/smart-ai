...
description: "Configure Amazon SageMaker with Smart AI to use deployed LLM endpoints for both chat and embedding models, supporting LMI and HuggingFace TEI deployments with AWS credentials"
---
