---
title: "Cohere"
description: "Configure Cohere's AI models with Smart AI, including setup for Command A for chat, embed-v4.0 for embeddings, and rerank-v3.5 for reranking capabilities"
---
