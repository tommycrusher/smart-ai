...
In Smart AI, embeddings are generated during indexing and then used by [codebase awareness](/guides/codebase-documentation-awareness) to perform similarity search over your codebase.
...
<Tabs>
  <Tab title="Hub">
  [Voyage Code 3 Embedder Block](https://smart-ai.dev/voyageai/voyage-code-3)
  </Tab>
    <Tab title="YAML">
...
[Transformers.js](https://huggingface.co/docs/transformers.js/index) is a JavaScript port of the popular [Transformers](https://huggingface.co/transformers/) library. It allows embeddings to be calculated entirely locally. The model used is `all-MiniLM-L6-v2`, which is shipped alongside the Smart AI extension.
...
<Tabs>
  ...
  {/* <Tab title="Hub">
  [HuggingFace Text Embedder Block](https://smart-ai.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
