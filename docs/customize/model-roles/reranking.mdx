...
In Smart AI, rerankers are designated using the `rerank` role and used by [codebase awareness](/guides/codebase-documentation-awareness) in order to select the most relevant code snippets after vector search.
...
<Tabs>
  ...
  {/* <Tab title="Hub">
  [Cohere Reranker English v3](https://smart-ai.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
  {/* HUB_TODO block doesn't exist */}
  {/* <Tab title="Hub">
  [GPT-4o LLM Reranker Block](https://smart-ai.dev/)
  </Tab> */}
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
  {/* HUB_TODO */}
  {/* <Tab title="Hub">
  [HuggingFace TEI Reranker block](https://smart-ai.dev/)
  </Tab> */}
    <Tab title="YAML">
    ```yaml title="config.yaml"
    name: My Config
