...
In Smart AI, these models are used for normal [Chat](../../ide-extensions/chat/quick-start). The selected chat model will also be used for [Edit](../../ide-extensions/edit/quick-start) and [Apply](./apply.mdx) if no `edit` or `apply` models are specified, respectively.
...
<Tabs>
  <Tab title="Hub">
  View the [Claude Opus 4.6 model block](https://smart-ai.dev/anthropic/claude-opus-4-6) or [Claude Sonnet 4 model block](https://smart-ai.dev/anthropic/claude-4-sonnet) on the hub.
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  <Tab title="Hub">
    <Tabs>
        <Tab title="Ollama">
        Add the [Ollama Gemma 3 27B block](https://smart-ai.dev/ollama/gemma3-27b) from the hub
        </Tab>
        <Tab title="Together">
        Add the [Together Gemma 2 27B Instruct block](https://smart-ai.dev/togetherai/gemma-2-instruct-27b) from the hub
        </Tab>
    </Tabs>
  </Tab>
  <Tab title="YAML">
...
<Tabs>
    <Tab title="Hub">
    Add the [OpenAI GPT-5.1 block](https://smart-ai.dev/openai/gpt-5.1) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
    <Tab title="Hub">
    Add the [xAI Grok-4.1 block](https://smart-ai.dev/xai/grok-4-1-fast-non-reasoning) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
    <Tab title="Hub">
    Add the [Gemini 3.1 Pro block](https://smart-ai.dev/google/gemini-3.1-pro-preview) from the hub
    </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
<Tabs>
  <Tab title="Hub">
    <Tabs>
        <Tab title="Ollama">
    Add the [Ollama Llama 3.1 8b block](https://smart-ai.dev/ollama/llama3.1-8b) from the hub
    </Tab>
    {/* HUB_TODO nonexistent block */}
    {/* <Tab title="LM Studio">
    Add the [LM Studio Llama 3.1 8b block](https://smart-ai.dev/explore/models) from the hub
    </Tab> */}
    </Tabs>
  </Tab>
  <Tab title="YAML">
...
<Tabs>
  ...
  {/* <Tab title="Hub">
    <Tabs>
    <Tab title="Ollama">
    Add the [Ollama Deepseek Coder 2 16B block](https://smart-ai.dev/explore/models) from the hub
    </Tab>
    <Tab title="LM Studio">
    Add the [LM Studio Deepseek Coder 2 16B block](https://smart-ai.dev/explore/models) from the hub
    </Tab>
    </Tabs>
  </Tab> */}
  <Tab title="YAML">
