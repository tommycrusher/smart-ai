---
title: "MCP servers"
description: "Learn how to use Model Context Protocol (MCP) blocks in Smart AI to integrate external tools, connect databases, and extend your development environment."
---

Model Context Protocol (MCP) servers let Smart AI connect to external tools, systems, and databases by running MCP servers.
