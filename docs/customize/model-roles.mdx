...
icon: "circle-info"
description: "Learn about the different model roles in Smart AI including chat, autocomplete, edit, apply, embeddings, and reranking for customizing your AI coding agent's capabilities"
---
