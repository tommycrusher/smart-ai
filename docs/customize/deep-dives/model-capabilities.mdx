---
title: "How to Configure Model Capabilities in Smart AI"
...
Smart AI needs to know what features your models support to provide the best experience. This guide explains how model capabilities work and how to configure them.

## What Are Model Capabilities?

Model capabilities tell Smart AI what features a model supports:
...
## How Smart AI Detects Model Capabilities

Smart AI uses a two-tier system for determining model capabilities:

### How Automatic Detection Works (Default)

Smart AI automatically detects capabilities based on your provider and model name. For example:
...
- [@smartai/llm-info](https://www.npmjs.com/package/@smartai/llm-info) - Image support detection

### How to Configure Capabilities Manually

You can add capabilities to models that Smart AI doesn't automatically detect in your `config.yaml`.

<Note>
  You cannot override autodetection - you can only add capabilities. Smart AI
...
2. **Using newer models** - Smart AI doesn't yet recognize a newly released model
...
Add tool support for a model that Smart AI doesn't recognize:
...
<Warning>
  An empty capabilities array does not disable autodetection. Smart AI will
...
3. **Keep Smart AI updated** - Newer versions improve autodetection

Remember: Setting capabilities only adds to autodetection. Smart AI will still use its built-in knowledge about your model in addition to your specified capabilities.

## Model Capability Support

This matrix shows which models support tool use and image input capabilities. Smart AI auto-detects these capabilities, but you can override them if needed.
