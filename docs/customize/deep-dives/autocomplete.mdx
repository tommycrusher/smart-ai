---
title: "Smart AI Autocomplete Setup and Configuration Guide"
description: "Step-by-step guide to setting up and configuring autocomplete in Smart AI, including Codestral, Ollama, and IDE settings."
...
## How to Set Up Autocomplete in Smart AI with Codestral (Recommended)
...
<Tabs>
  <Tab title="Hub">
  [Mistral Codestral model block](https://smart-ai.dev/mistral/codestral)
  </Tab>
  <Tab title="YAML">
...
## How to Set Up Autocomplete in Smart AI with Ollama (Local Model)
...
<Tabs>
  <Tab title="Hub">
  [Ollama Qwen 2.5 Coder 1.5B model block](https://smart-ai.dev/ollama/qwen2.5-coder-1.5b)
  </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
## Autocomplete Configuration Options in Smart AI

### Autocomplete Models Available on the Smart AI Mission Control

Explore autocomplete model configurations on [the hub](https://smart-ai.dev/explore/models?roles=autocomplete)

### Customize Autocomplete User Settings in the Smart AI Extension
...
## Autocomplete FAQs and Troubleshooting in Smart AI
...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "Smart AI" button in the status bar, and in JetBrains by going to Settings -> Tools -> Smart AI).
...
5. Check the output of the logs to find any potential errors: <kbd>cmd/ctrl</kbd> + <kbd>shift</kbd> + <kbd>P</kbd> -> "Toggle Developer Tools" -> "Console" tab in VS Code, ~/.smart-ai/logs/core.log in JetBrains.
...
### How to Turn Off Autocomplete in Smart AI (VS Code and JetBrains)

#### VS Code

Click the "Smart AI" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "Smart AI" and uncheck the box for "Enable Tab Autocomplete".
...
Open Settings -> Tools -> Smart AI and uncheck the box for "Enable Tab Autocomplete".
