...
<CardGroup cols={3}>
  ...
  <Card title="Clear Your Inbox Queue" icon="inbox" href="https://smart-ai.dev/inbox">
...
## Integrations
<Note>
  Connect Smart AI to your existing developer tools to automate the repetitive work you don't have time for.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Slack" icon="slack" href="/mission-control/integrations/slack">
    Mention <code>@Smart AI</code> in Slack to trigger Agents and receive updates.
  </Card>
...
You can go to [Mission Control Integrations](https://smart-ai.dev/integrations) for the full list of tools you can connect, or for more information see [the docs page](https://docs.smart-ai.dev/mission-control/integrations).
...
<CodeGroup>
    ...
    ```bash yarn
    yarn global add @smartai/cli
    ```

    ```bash pnpm
    pnpm add -g @smartai/cli
    ```
...
Learn more about [extension features](https://docs.smart-ai.dev/ide-extensions/quick-start) and how to [customize](https://docs.smart-ai.dev/customize/overview) →

<CardGroup cols={2}>
  <Card
    title="VS Code"
    icon="code"
    href="https://marketplace.visualstudio.com/items?itemName=Smart AI.continue"
  >
