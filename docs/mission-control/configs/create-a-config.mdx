...
description: "Learn how to create custom AI coding configs in Smart AI Mission Control by remixing existing configs or building new ones from scratch with reusable blocks and YAML configuration."
sidebarTitle: "Create a Config"
---

## How to Create a Config from Scratch

To create a config from scratch, navigate to [your config settings](https://smart-ai.dev/settings/configs). 
...
Alternatively, you can edit the config YAML directly before clicking "Create config". Refer to examples of configs on [smart-ai.dev](https://smart-ai.dev) and visit the [YAML Reference](/reference#complete-yaml-config-example) docs for more details.
