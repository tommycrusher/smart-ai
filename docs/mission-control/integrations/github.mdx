...
[Connect GitHub in Mission Control →](https://smart-ai.dev/integrations/github)

## Access and permissions

When connecting GitHub, you choose which repositories to grant access to and approve the requested permissions. These allow Smart AI to read repository data and open pull requests on your behalf.
