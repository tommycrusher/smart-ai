...
[Connect Sentry in Mission Control →](https://smart-ai.dev/integrations/sentry)
...
Agents can access projects and issues you have permission to view. Approved permissions allow Smart AI to analyze error events, read issue details, and create pull requests or GitHub issues on your behalf.
