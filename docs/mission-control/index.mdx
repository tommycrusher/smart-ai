---
title: "Smart AI Mission Control"
description: "Smart AI Mission Control is the control plane for cloud agents where teams create, monitor, and automate AI-powered workflows across their toolchain. Create Tasks, manage Agents, connect Integrations, and share with your team all in one place."
sidebarTitle: "Overview"
---

## What You Can Do in Mission Control

Mission Control is where developers and teams use Smart AI to power everyday coding workflows. From quick one-off Tasks to fully automated pipelines, everything starts here with Cloud Agents (AI-powered).
...
<CardGroup cols={3}>
  ...
  <Card title="Create a Task" icon="plus" href="https://smart-ai.dev">
    Start with a prompt and run an Agent on demand.
  </Card>

  <Card title="Build Workflows for Cloud Agents" icon="clock" href="https://smart-ai.dev/agents/new">
    Automate work using GitHub triggers, cron schedules, or webhooks.
  </Card>

  <Card title="Add Integrations" icon="workflow" href="https://smart-ai.dev/integrations">
