---
title: "Sharing"
description: "Connect with the Smart AI community to discover, share, and collaborate on AI development tools."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Public" icon="globe">
    Available to everyone in Smart AI Mission Control.  
...
## Community
<CardGroup cols={2}>
  <Card title="Join the Discussion" icon="people" href="https://github.com/tommycrusher/smart-ai/discussions">
    Join thousands of developers using Smart AI and share your experiences.
    </Card>
  <Card title="Share your feedback" icon="globe" href="https://github.com/tommycrusher/smart-ai/discussions">
