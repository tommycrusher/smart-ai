---
title: "Quick Start"
description: "Get started with Smart AI's Agent mode to automatically implement code changes, fix bugs, and run commands using AI-powered tools that can modify your codebase based on natural language instructions"
---
...
<Info>
  ...
  model or provider doesn't support tools, or Smart AI doesn't yet support tools
...
By default, Agent mode will ask permission when it wants to use a tool. Click `Smart AI` to allow Agent mode to proceed with the tool call or `Cancel` to reject it.
