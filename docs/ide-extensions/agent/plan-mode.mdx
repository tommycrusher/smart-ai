---
title: "Plan Mode in Smart AI – Safe, Read-Only Code Exploration"
sidebarTitle: "Plan Mode"
description: "Learn how to use Plan Mode in Smart AI to explore and understand codebases safely with read-only tools, search, and analysis before making changes"
---
