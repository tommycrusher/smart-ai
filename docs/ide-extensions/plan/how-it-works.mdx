...
1. Smart AI sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by Smart AI. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/tommycrusher/smart-ai/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
