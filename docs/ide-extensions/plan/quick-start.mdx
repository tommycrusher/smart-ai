---
title: "Quick Start"
description: "Get started with Smart AI's Plan mode to safely explore codebases, plan refactors, debug issues, and develop implementation strategies without modifying code before switching to execution"
---
