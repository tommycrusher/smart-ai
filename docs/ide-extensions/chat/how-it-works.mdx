...
description: "Smart AI's Chat feature provides a conversational interface with AI models directly in your IDE sidebar."
---

## How Chat Core Functionality Works

When you start a chat conversation, Smart AI:
