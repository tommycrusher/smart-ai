---
title: "Recommended Models for Chat in Smart AI"
description: "Choose the best chat model for Smart AI, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
