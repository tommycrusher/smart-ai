---
title: "How Autocomplete Works in Smart AI"
sidebarTitle: "How Autocomplete Works"
description: "Understand how Smart AI's autocomplete works, including timing optimization, context retrieval from your codebase, and filtering to improve AI code suggestions."
---
...
Smart AI uses a number of retrieval methods to find relevant snippets from your codebase to include in the prompt.
