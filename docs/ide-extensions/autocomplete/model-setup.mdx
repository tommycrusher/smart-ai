---
title: "Recommended Models for Autocomplete in Smart AI"
description: "Choose the best autocomplete model for Smart AI, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, Smart AI supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
