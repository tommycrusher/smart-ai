...
description: "Learn Smart AI's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to Smart AI! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Smart AI's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Smart AI](/ide-extensions/install) and [signed
  in](https://auth.smart-ai.dev/) to get started.
</Info>
...
Press **Enter** and watch Smart AI suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
Smart AI will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch Smart AI refactor your code automatically!
</Step>

<Step title="Review Changes">
Smart AI will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? Smart AI offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core Smart AI features. Here's what to explore next:
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="users"
    href="https://github.com/tommycrusher/smart-ai/discussions"
  >
    Get help and share experiences with other Smart AI users
  </Card>
</CardGroup>
...
<Info>
  **Need help?** Check our [troubleshooting guide](/troubleshooting) or ask a
  ...
  discussions](https://github.com/tommycrusher/smart-ai/discussions).
</Info>
