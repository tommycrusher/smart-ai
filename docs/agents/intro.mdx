...
<Info>
  Mission Control is in beta. Please share any feedback with us in [GitHub discussions](https://github.com/tommycrusher/smart-ai/discussions).
</Info>
...
<Tip>
  If you haven't already, create an account and connect your GitHub repositories in [Mission Control](https://smart-ai.dev/).
</Tip>

<Steps>
  <Step title="Navigate to Your Agents Page">
    Go to [Mission Control Agents page](https://smart-ai.dev/agents) and select an existing workflow with a pre-configured Cloud Agent.
  </Step>
...
Before creating your own agent, let's see one in action! The fastest way to experience the power of Smart AI agents is with our demo repository.
...
<Steps>
  ...
  <Step title="🎯 Access Mission Control">
    Go to [Mission Control](https://smart-ai.dev/) and:
    - **Connect GitHub** and authorize Smart AI when prompted
...
<Tabs>
  <Tab title="🌐 Mission Control">
    **Web interface for interactive use**
    ...
    Access at [smart-ai.dev/agents](https://smart-ai.dev/agents)
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Start Small" icon="seedling">
    Begin with tasks you're confident Smart AI can handle, like fixing known bugs with simple solutions.
  </Card>
  
  <Card title="Practice Locally" icon="terminal">
    Test with [Smart AI CLI](../guides/cli) in TUI mode before deploying automation.
  </Card>
...
<Info>
  **Learn More**: Explore advanced patterns and case studies on the [Continuous AI Blog](https://blog.smart-ai.dev).
</Info>
