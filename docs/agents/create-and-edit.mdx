...
description: "Build custom AI workflows for your Cloud Agents with prompts, rules, and tools through the Smart AI Mission Control interface"
sidebarTitle: "Create & Edit"
---

<Card title="Creating Custom Cloud Agents" icon="wrench">
  You can only create and edit AI Agents in the Smart AI Mission Control web interface. This ensures proper validation, versioning, and team collaboration features.
</Card>
...
<Steps>
  <Step title="🧭 Navigate to Create Agent">
    Navigate to the [New Agent page](https://smart-ai.dev/agents/new).
  ...
  <Step title="🧩 Fill Out the Agent Form">
    ...
    | **Tools ([MCPs](https://smart-ai.dev/hub?type=mcpServers))** | Select built-in or custom MCPs | `GitHub, PostHog, Supabase, etc.` |
    | **[Rules](https://smart-ai.dev/hub?type=rules)** | Add any organizational rules | `continuedev/gh-pr-commit-workflow` |
    | **[Model](https://smart-ai.dev/hub?type=models)** | Choose a default LLM | `Claude Sonnet 4.5` |
...
From the **[Agents](https://smart-ai.dev/agents)** page, click your agent's name. Change any of the fields in the edit form, then click **"Save Changes"**.
...
<CardGroup cols={2}>
  <Card title="Security Scanner Cloud Agent" icon="shield" href="https://smart-ai.dev/continuedev/snyk-continuous-ai-agent">
  ...
  <Card title="Performance Monitoring Cloud Agent" icon="gauge" href="https://smart-ai.dev/continuedev/netlify-continuous-ai-agent">
  ...
  <Card title="Error Monitoring Agent" icon="bug" href="https://smart-ai.dev/continuedev/sentry-continuous-ai-agent">
  ...
  <Card title="GitHub Management Cloud Agent" icon="github" href="https://smart-ai.dev/continuedev/github-manager-ai-agent">
  ...
  <Card title="Database Management Cloud Agent" icon="database" href=" https://smart-ai.dev/continuedev/supabase-agent">
