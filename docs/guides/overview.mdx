...
- [Running Smart AI Without Internet](/guides/running-continue-without-internet) - Offline development setup
...
- [Notion + Smart AI Guide](/guides/notion-continue-guide) - Automate docs, tasks, and release workflows
...
<CardGroup cols={3}>
  ...
  <Card title="Smart AI Docs MCP Cookbook" icon="book" href="/guides/continue-docs-mcp-cookbook">
  ...
  <Card title="Snyk + Smart AI Mission Control Agent Cookbook (MCP)" icon="shield" href="/guides/snyk-mcp-continue-cookbook">
