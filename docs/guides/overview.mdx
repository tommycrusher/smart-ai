---
title: "How to Use Smart AI Guides"
description: "Comprehensive collection of practical guides for Smart AI including model setup, local development with Ollama, offline usage, self-hosting, custom context providers, and advanced customization tutorials"
---

## What Model & Setup Guides Are Available

- [Using Ollama with Smart AI](/guides/ollama-guide) - Local AI development with Ollama
- [How to Self-Host a Model](/guides/how-to-self-host-a-model) - Self-hosting AI models
- [Running Smart AI Without Internet](/guides/running-smartai-without-internet) - Offline development setup
...
- [How to Use Smart AI CLI (cn)](/guides/cli) - Command-line interface for Smart AI
...
- [Notion + Smart AI Guide](/guides/notion-smartai-guide) - Automate docs, tasks, and release workflows
- [Pull Request Review Bot with GitHub Actions](/guides/github-pr-review-bot) - Set up automated, privacy-first code reviews using Smart AI CLI

## MCP Integration Cookbooks

Step-by-step guides for integrating Model Context Protocol (MCP) servers with Smart AI:

<CardGroup cols={3}>

  <Card title="Smart AI Docs MCP Cookbook" icon="book" href="/guides/smartai-docs-mcp-cookbook">
    Use the Smart AI Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows
  </Card>

  <Card title="GitHub MCP Cookbook" icon="github" href="/guides/github-mcp-smartai-cookbook">
    Use GitHub MCP to list, filter, and summarize open issues and merged PRs, and post AI-generated comments
  </Card>

  <Card title="Atlassian MCP Cookbook" icon="atlassian" href="/guides/atlassian-mcp-smartai-cookbook">
  ...
  <Card title="Sanity CMS Integration Cookbook" icon="database" href="/guides/sanity-mcp-smartai-cookbook">
  ...
  <Card title="Snyk + Smart AI Mission Control Agent Cookbook (MCP)" icon="shield" href="/guides/snyk-mcp-smartai-cookbook">
    Integrate Snyk MCP via Smart AI Mission Control to scan code, deps, IaC, and containers
  </Card>
  ...
  <Card title="dlt Data Pipelines Cookbook" icon="pipe" href="/guides/dlt-mcp-smartai-cookbook">
    Build AI-powered data pipelines with dlt MCP for pipeline inspection, schema management, and debugging
  </Card>

  <Card title="Klavis AI Cookbook" icon="K" href="/guides/klavis-mcp-smartai-cookbook">
    Use Smart AI and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail
  </Card>
...
Have a guide idea or found an issue? We welcome contributions! Check our [GitHub repository](https://github.com/tommycrusher/smart-ai) to get involved.
