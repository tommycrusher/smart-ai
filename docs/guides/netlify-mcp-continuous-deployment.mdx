...
description: "Optimize web performance with A/B testing, automated monitoring, and data-driven improvements using Netlify MCP and Smart AI."
...
- [Netlify MCP](https://smart-ai.dev/netlify/netlify-mcp) configured
- [Netlify Development Rules](https://smart-ai.dev/netlify/netlify-development) (recommended)
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Netlify Continuous AI Agent](https://smart-ai.dev/continuedev/netlify-continuous-ai-agent) on Smart AI Mission Control and click **"Install Agent"** or run:
...
<Step title="Configure Netlify MCP">
  ...
  `netlify login`
  2. Visit [Netlify MCP on Smart AI
  Hub](https://smart-ai.dev/netlify/netlify-mcp)
  3. Follow the configuration instructions for your editor

</Step>

  <Step title="Add Development Rules">
    Install the [Netlify Development Rules](https://smart-ai.dev/netlify/netlify-development) bundle for best practices:

    1. Visit the bundle page on Smart AI Mission Control
...
jobs:
  performance:
    ...
    steps:
      ...
      - name: Authenticate Smart AI CLI
        env:
          SMARTAI_API_KEY: ${{ secrets.SMARTAI_API_KEY }}
        run: |
          cn auth login --api-key "$SMARTAI_API_KEY"
          echo "✅ Smart AI CLI authenticated"
...
- Install [Netlify MCP](https://smart-ai.dev/netlify/netlify-mcp) from Smart AI Mission Control
...
- [Netlify MCP on Smart AI Mission Control](https://smart-ai.dev/netlify/netlify-mcp)
- [Core Web Vitals Guide](https://web.dev/vitals/)
- [Netlify Analytics Documentation](https://docs.netlify.com/analytics/)
- [Smart AI Performance Guides](https://docs.smart-ai.dev/guides)
