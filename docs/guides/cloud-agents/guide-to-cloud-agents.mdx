...
With Smart AI, Cloud Agents run in [Mission Control](../../mission-control), where teams configure execution, connect tools, review outcomes, and decide which workflows become automated over time.
...
<Tabs>
  <Tab title="On-Demand Tasks">
    ...
    You can trigger agents manually (with Smart AI, use the [Smart AI CLI](../../cli/quickstart) or [Mission Control](../../mission-control)) when you need a one-off task that you want to review.
  ...
  <Tab title="Automated Workflows">
    ...
    <Card title="Example: Security Agent" icon="lock">
      ...
      A "[Security Agent](https://smart-ai.dev/integrations/snyk)" automatically opens PRs for Snyk issues with high and critical security vulnerabilities and implements the fixes.
...
<AccordionGroup>
  ...
  <Accordion title="Context Access" icon="folder-open">
    ...
    - **Cloud Agents:** Full repository access + [integrated tools](https://smart-ai.dev/integrations) (Sentry, Snyk, Linear, etc.)
...
<CardGroup cols={2}>
  <Card title="Explore Cloud Agent Integrations" icon="rocket" href="https://smart-ai.dev/integrations">

    Browse ready-to-use AI agents in Smart AI Mission Control.
  ...
  <Card title="Mission Control Setup" icon="terminal" href="https://smart-ai.dev">

    Get started with Smart AI Mission Control.
