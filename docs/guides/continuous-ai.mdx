...
**Smart AI Implementation**: Using [Chat](/ide-extensions/chat/quick-start) or [Edit](/ide-extensions/edit/quick-start) mode for one-off coding tasks.
...
**Smart AI Implementation**: Using [Smart AI CLI](/guides/cli) with custom rules and integrations into CI/CD pipelines.
...
**Smart AI Implementation**: Fully automated [agents](/ide-extensions/agent/quick-start) with strict permissions and safety guardrails.
...
Use Smart AI CLI's permission system to gradually expand AI capabilities:

```yaml ~/.smart-ai/permissions.yaml
permissions:
...
<Card title="Want to dive deeper?" icon="rocket">
      Check out our guides on [Smart AI CLI](/guides/cli) and [Understanding
