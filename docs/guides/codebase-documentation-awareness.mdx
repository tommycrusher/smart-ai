...
Rules guide agent mode's behavior and understanding. Place markdown files in `.smart-ai/rules` in your project to provide context:
...
[DeepWiki MCP](https://smart-ai.dev/deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](https://smart-ai.dev/upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
...
2. **Add rules**: Create `.smart-ai/rules` files to provide context about your project structure
...
The new approach provides better integration with Smart AI's Agent mode features and more intelligent context selection.
