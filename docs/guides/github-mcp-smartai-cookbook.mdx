---
title: "GitHub Issues and PRs with GitHub MCP and Smart AI"
description: "Use Smart AI and the GitHub MCP to list, summarize, and act on open issues and recently merged pull requests with natural language prompts."
sidebarTitle: "GitHub Issues with Smart AI"
---
...
<Card title="What You'll Build" icon="github">
  A GitHub workflow assistant that uses Smart AI with the GitHub MCP to:
...
<Step title="Configure GitHub Token">
  Add your `GITHUB_TOKEN` to your [Smart AI Mission Control agent's environment variables](https://smart-ai.dev/settings).
  </Step>
</Steps>
...
<Card title="🚀 Fastest Path to Success" icon="rocket">
  Use the GitHub MCP from Smart AI Mission Control for one-click setup, or add it via CLI.
</Card>
...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via Smart AI Mission Control">
        Visit the [GitHub Project Manager Agent](https://smart-ai.dev/continuedev/github-project-manager-agent) on Smart AI Mission Control and click **Install** to add it to your agent.
...
<Accordion title="Agent Requirements">
    To use GitHub MCP with Smart AI CLI, you need either:
...
- `SMARTAI_API_KEY`: From [smart-ai.dev/settings/api-keys](https://smart-ai.dev/settings/api-keys)
...
<CardGroup cols={2}>
  <Card title="GitHub MCP (Anthropic)" icon="link" href="https://smart-ai.dev/anthropic/github-mcp">
    Anthropic GitHub MCP on Smart AI Mission Control
  </Card>
  <Card title="MCP in Smart AI" icon="book" href="/customize/deep-dives/mcp">
    How MCP works with Smart AI agents
  </Card>
  <Card title="GitHub Project Manager Agent" icon="robot" href="https://smart-ai.dev/continuedev/github-project-manager-agent">
    Pre-configured agent on Smart AI Mission Control
  </Card>
