...
Smart AI provides a [reusable workflow](https://github.com/tommycrusher/smart-ai/blob/main/.github/workflows/continue-agents.yml) that handles agent discovery, parallel execution, and GitHub Check reporting.
