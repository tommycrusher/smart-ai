---
title: "Automating Documentation Updates with Smart AI CLI"
sidebarTitle: "Automating Documentation Updates with Smart AI CLI"
description: "Learn how to create automated documentation generation workflows using Smart AI CLI. Set up AI agents to analyze code changes and generate or update documentation automatically in GitHub workflows or local development."
---
...
This guide demonstrates how to create automated documentation generation based on code updates in a git branch using the Smart AI CLI, either as part of your local workflow or as part of a GitHub workflow.

This process utilizes the **Smart AI CLI** (`cn`) in **headless mode** to analyze changes and generate the necessary documentation, and commit and push the changes. The goal is to keep the workflow as simple as possible by using straightforward shell commands, Smart AI CLI prompts, and basic git operations.

## Why Use Smart AI CLI for Documentation?
...
<CardGroup cols={1}>
  <Card title="Install Smart AI CLI" icon="terminal">
    Smart AI CLI requires Node.js 20 or higher.
    
    <CLIInstall />
  </Card>

  <Card title="Smart AI API Key" icon="key">
    Get your API key from [Smart AI Mission Control](https://smart-ai.dev/settings/api-keys) and set:
    ```bash
    export SMARTAI_API_KEY=your_key_here
    ```
    <Info>
    You can use the Smart AI CLI in headless mode without interactive login by setting the `SMARTAI_API_KEY` environment variable.
    </Info>
  </Card>
...
<Steps>
  <Step title="Environment Setup">
    Validate environment, install Smart AI CLI, and set up authentication with API keys.
  </Step>
  ...
  <Step title="AI Documentation Generation">
    Use Smart AI CLI with custom rules to analyze changes and generate or update documentation files.
    <Tip>
...
- **continue_config:** The Smart AI agent configuration to use
  - Consider setting a default value if you have a default config your'd like to use
- **continue_org:** The Smart AI org to use
...
jobs:
  write-docs:
    ...
    env:
      ...
      SMARTAI_ORG: ${{ github.event.inputs.continue_org }}
      SMARTAI_CONFIG: ${{ github.event.inputs.continue_config }}
    ...
    - name: Verify Smart AI CLI installation
      run: |
        echo "Checking Smart AI CLI version..."
        cn --version || exit 1
    ...
    - name: Generate documentation with Smart AI CLI
      run: |
        echo "Running Smart AI agent to generate documentation..."
...
<Warning>
Make sure to set your `SMARTAI_API_KEY` environment variable before running local scripts to enable headless mode.
</Warning>

When using the Smart AI CLI on your local machine, you can build workflows in various ways, one of which is by simply creating shell scripts that you can run, which call the CLI.
...
# Generate documentation with Smart AI CLI
echo "Running Smart AI agent to generate documentation..."
...
Ready to implement automated documentation with Smart AI CLI? Here are some helpful resources to get you started:

<CardGroup cols={2}>
  <Card title="Smart AI CLI Guide" icon="terminal" href="/guides/cli">
    Learn the fundamentals of using Smart AI CLI for automated coding tasks and headless workflows.
  </Card>
  ...
  <Card title="Video: Leverage AI to help with your docs" icon="video" href="https://www.youtube.com/watch?v=rJ2taa8OLvY">
    Checkout this video from Tetrate about using Smart AI Agents to help with writing your docs.
  </Card>

  <Card title="Smart AI Mission Control" icon="users" href="https://smart-ai.dev">
    Browse pre-built agents and configurations from the Smart AI community.
  </Card>
</CardGroup>
