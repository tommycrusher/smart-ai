---
title: "Slack and Gmail Automation with Klavis AI Strata MCP and Smart AI"
description: "Use Smart AI and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail with natural language prompts."
sidebarTitle: "Klavis AI with Smart AI"
---
...
<Card title="What You'll Build" icon="wand-magic-sparkles">
  A communication workflow assistant that uses Smart AI CLI with Klavis AI's Strata MCP to manage and automate multi-platform workflows including Slack and Gmail—all through simple natural language prompts.
</Card>
...
<Tabs>
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on Smart AI Hub">
        Go to the [Smart AI Hub](https://smart-ai.dev) and [create a new agent](https://smart-ai.dev/agents/new).
      </Step>
    ...
    <Info>
      **Pro tip**: Learn how to integrate and use [Klavis Strata](https://www.klavis.ai/docs/knowledge-base/use-mcp-server/continue) with Smart AI through CLI and IDE.
    </Info>
  ...
  <Tab title="CLI Setup">
    <Steps>
      ...
      <Step title="Launch Smart AI with Klavis MCP">
        ...
        Now try:
        ```
        "Send a Slack message to #general saying 'Hello from Smart AI!'"
        ```
      </Step>
    </Steps>
  </Tab>
...
<Accordion title="Agent Requirements">
  To use Klavis AI Strata MCP with Smart AI CLI, you need either:
  - **Smart AI CLI Pro Plan** with the models add-on, OR
  - **Your own API keys** added to Smart AI Hub secrets
...
<CardGroup cols={2}>
  ...
  <Card title="MCP in Smart AI" icon="puzzle-piece" href="/customize/deep-dives/mcp">
    Learn how MCP works with Smart AI agents
  </Card>
  <Card title="Smart AI Hub" icon="globe" href="https://smart-ai.dev">
    Create and manage your Smart AI agents
  </Card>
</CardGroup>