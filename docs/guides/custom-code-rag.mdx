...
To integrate your custom RAG system with Smart AI, you'll create an MCP (Model Context Protocol) server. MCP provides a standardized way for AI tools to access external resources.
...
### Configure Smart AI to use your MCP server

Add your MCP server to Smart AI's configuration:
