---
title: "Jira Issues and Confluence Pages with Atlassian MCP and Smart AI"
description: "Use Smart AI and the Atlassian Rovo MCP to search, summarize, and manage Jira issues, Confluence pages, and Compass components with natural language prompts."
sidebarTitle: "Atlassian Workflows with Smart AI"
---
...
<Card title="What You'll Build" icon="atlassian">
  An Atlassian workflow assistant that uses Smart AI with the Atlassian Rovo MCP to:
...
|-------|----------|-----------|------|
| **Jira Agent** | Issue Management | Search issues, create stories, sprint planning, status updates, bulk operations | [View Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-jira-agent) |
| **Confluence Agent** | Documentation | Search pages, summarize docs, create/update pages, manage spaces | [View Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-confluence-agent) |

<Note>
  **Cross-product workflows**: Both agents can work with Jira, Confluence, and Compass. Choose based on your primary focus area, or create your own agent using the [Atlassian MCP](https://smart-ai.dev/atlassian/atlassian-mcp). The Atlassian MCP can work with Jira, Compass, or Confluence.
</Note>
...
<Tabs>
  <Tab title="📋 Jira Agent (Recommended for Issue Management)">
    <Steps>
      <Step title="Use the Jira Agent">
        Visit the [Atlassian Continuous AI - Jira Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-jira-agent) on Smart AI Mission Control. This agent is optimized for:
  ...
  <Tab title="📄 Confluence Agent (Recommended for Documentation)">
    <Steps>
      <Step title="Use the Confluence Agent">
        Visit the [Atlassian Continuous AI - Confluence Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-confluence-agent) on Smart AI Mission Control. This agent is optimized for:
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Create a New Agent on Smart AI Mission Control">
...
<Accordion title="Agent Requirements">
    To use Atlassian MCP with Smart AI CLI, you need either:
...
<Note>
  **Using the Jira Agent**: All examples below use the [Jira Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-jira-agent) which is optimized for issue management.
</Note>
...
<Note>
  **Using the Confluence Agent**: All examples below use the [Confluence Agent](https://smart-ai.dev/continuedev/atlassian-continuous-ai-confluence-agent) which is optimized for documentation management.
</Note>

Access, search, and manage your team's documentation directly from Smart AI.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP in Smart AI" icon="book" href="/customize/deep-dives/mcp">
    How MCP works with Smart AI agents
  </Card>
