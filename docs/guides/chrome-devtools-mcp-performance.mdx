...
description: "Measure and optimize web performance with Chrome DevTools MCP, automated performance traces, and Core Web Vitals monitoring using Smart AI."
...
This guide shows you how to leverage these features through natural language with Smart AI CLI!
...
- [Smart AI CLI](https://docs.smart-ai.dev/guides/cli)
- [Chrome DevTools MCP](https://smart-ai.dev) configured
    ...
    **Perfect for:** Immediate results with optimized prompts and built-in performance analysis
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Chrome Dev Tools Agent](https://smart-ai.dev/continuedev/chrome-dev-tools-agent) on Smart AI Mission Control and click **"Install Agent"** or run:
        ...
        - **[Chrome DevTools MCP](https://smart-ai.dev/google/chrome-devtools-mcp)** for reliable browser automation
      </Step>
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Chrome DevTools MCP to Your Assistant">
        Visit the [Chrome DevTools MCP](https://smart-ai.dev/google/chrome-devtools-mcp) on Smart AI Mission Control and add it to your assistant, or add this to your configuration:
...
Now you can use natural language prompts to analyze web performance. The Smart AI agent automatically calls the appropriate Chrome DevTools MCP tools.
...
This workflow automatically validates web performance on pull requests using the Smart AI CLI in headless mode. It records performance traces, extracts Core Web Vitals, and posts a summary report as a PR comment.
...
<Card title="Continuous AI" icon="rocket">
  Your performance workflow now operates at **[Level 2 Continuous AI](https://blog.smart-ai.dev/what-is-continuous-ai-a-developers-guide/)** - AI handles routine performance analysis and debugging with human oversight through review and approval of changes.
</Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Smart AI Mission Control" icon="circle-nodes" href="https://smart-ai.dev">
