...
description: "Learn how to work with Smart AI's configuration system. Understand how to use hub models, rules, and tools, create local configurations, and organize your setup for maximum reusability."
---

## What Are Models, Rules, and Tools?

Smart AI configs are built from three main types of configuration:
...
Pre-built models, rules, and tools from the Smart AI community that you can import and use immediately
</Card>
</Columns>
...
Smart AI hub uses a slug in the format of `owner/item-name` to resolve blocks.

For example, to use the [Claude 4 Sonnet model](https://smart-ai.dev/anthropic/claude-4-sonnet), you'd reference it as `anthropic/claude-4-sonnet`.
...
<Columns cols={2}>
<Card title="Workspace" icon="folder-open">
`.env` file at your project root, or in `<workspace-root>/.smart-ai/.env`
</Card>

<Card title="Global" icon="globe">
`.env` file in `~/.smart-ai/.env`
</Card>
</Columns>
...
- **[Smart AI Mission Control](https://smart-ai.dev)**: Browse community models, rules, and tools
