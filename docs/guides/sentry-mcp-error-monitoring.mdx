...
<Note>
  ...
  **Mission Control Benefits:**
  ...
  - **Dedicated inbox view** - Monitor all Sentry-related agent activity at [smart-ai.dev/inbox?view=sentry](https://smart-ai.dev/inbox?view=sentry)
...
<Card title="What You'll Build" icon="bug">
  An automated error monitoring system that uses Smart AI CLI with Sentry MCP to analyze production errors, identify root causes with AI, and create detailed GitHub issues with suggested fixes.
</Card>
...
- [Smart AI CLI](https://docs.smart-ai.dev/guides/cli) with **active credits** (required for API usage)
...
<Steps>
  ...
  <Step title="Set up Smart AI CLI Account & API Key">
    1. Visit [Smart AI Organizations](https://smart-ai.dev/settings/organizations)
    2. Sign up or log in to your Smart AI account
...
<Tip>
  Smart AI CLI handles complex error analysis and API interactions - you just need to provide the right prompts!
</Tip>
...
<Tabs>
  <Tab title="Configure Sentry MCP">
    ...
    The Sentry MCP supports multiple configuration methods. For Smart AI CLI, OAuth is recommended:
  ...
  <Tab title="Sentry API Credentials">
    ...
    3. Name it "Smart AI CLI Error Analysis"
...
<Tabs>
    ...
    **Perfect for:** Immediate error analysis with AI-powered root cause detection and built-in debugging
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Sentry Continuous AI Agent](https://smart-ai.dev/continuedev/sentry-continuous-ai-agent) on Smart AI Mission Control and click **"Install Agent"** or run:
      ...
      <Step title="Run Error Analysis">
        Navigate to your project directory and enter this prompt in the Smart AI CLI TUI:
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Sentry MCP to Smart AI CLI">
      ...
      <Step title="Create Custom Error Analysis Prompts">
        Use this prompt template with Smart AI CLI to analyze Sentry errors:
...
<Accordion title="Agent Requirements">
  ...
  - **Your own API keys** added to Smart AI Mission Control secrets (same as Step 1)
...
Use Smart AI CLI to perform intelligent error analysis. Enter these prompts in the Smart AI CLI TUI:
...
Create actionable GitHub issues from Sentry errors. Enter this prompt in the Smart AI CLI TUI:
...
Automate error monitoring with the [Sentry Release GitHub Action](https://docs.sentry.io/product/releases/setup/release-automation/github-actions/) and Smart AI CLI to create comprehensive, AI-powered issue descriptions:

<Tip>
  **Why Combine Sentry Releases with Smart AI CLI?**
  - **Release Tracking**: Associate errors with specific deployments
  - **AI-Powered Analysis**: Smart AI CLI generates detailed issue descriptions with root cause analysis
    ...
    steps:
      ...
      - name: Analyze Sentry Errors and Create Issues
        ...
        run: |
          ...
          # Use Smart AI CLI to analyze errors and generate comprehensive issue descriptions
...
<Info>
  **Workflow Best Practices**:
  ...
  - Use Smart AI CLI to generate comprehensive, AI-powered issue descriptions
...
<Card title="Continuous AI Error Monitoring" icon="shield-check">
  Your system now operates at **[Level 2 Continuous AI](https://blog.smart-ai.dev/what-is-continuous-ai-a-developers-guide/)** - AI handles routine error analysis with human oversight through GitHub issue review and resolution.
</Card>

## Advanced Error Analysis Prompts

Enhance your workflow with these advanced Smart AI CLI prompts:
...
<Warning>
  **Protect Your API Keys**:
  ...
  - Use Smart AI CLI's secure secret storage
...
| OAuth prompt not appearing | Check that Smart AI CLI has proper MCP configuration |
...
- Integrate [Slack MCP](https://smart-ai.dev/slack/slack-mcp) for error alerts
- Join the [GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) for support
...
- [Smart AI CLI Guide](https://docs.smart-ai.dev/guides/cli)
- [Continuous AI Best Practices](https://blog.smart-ai.dev/what-is-continuous-ai-a-developers-guide/)
