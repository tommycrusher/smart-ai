...
<CardGroup cols={2}>
  <Card
    title="Building Async Agents with Smart AI CLI"
    icon="blog"
    href="https://blog.smart-ai.dev/building-async-agents-with-continue-cli/"
  >
  ...
  <Card
    ...
    icon="book"
    href="https://docs.smart-ai.dev/guides/continuous-ai"
  >
