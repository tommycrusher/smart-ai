---
title: "Contributing to Smart AI with Model Context Protocol (MCP)"
description: "Use the Smart AI Docs MCP to write cookbooks, guides, and documentation with AI-powered workflows."
sidebarTitle: "Smart AI Docs MCP Cookbook"
---

<Card title="What You'll Build" icon="book-open-cover">
  Master using the Smart AI Docs MCP to contribute documentation, create cookbooks, and maintain consistency across Smart AI's docs - all through natural language prompts.
</Card>
...
- Smart AI account with **Hub access**
- Read: [Contributing to Smart AI Documentation](/CONTRIBUTING) for setup instructions
- Forked the [continuedev/continue](https://github.com/continuedev/continue) repository
- Node.js 20+ and Smart AI CLI installed

<Warning>
  This cookbook assumes you've read the setup in the [CONTRIBUTING guide](/CONTRIBUTING). If you haven't, start there first.
</Warning>

## Smart AI Docs MCP Setup

<Card title="Fastest Path to Success" icon="rocket">
  Use the pre-built [Docs Assistant - Mintlify agent](https://smart-ai.dev/continuedev/docs-mintlify) that includes the Smart AI Docs MCP and is ready to use immediately.
</Card>

<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    ```bash
    # From your Smart AI docs directory
    cn --config continuedev/docs-mintlify
    ```

    This agent includes:
    - **Smart AI Docs MCP** for searching Smart AI documentation
  ...
  <Tab title="🛠️ Custom Agent">
    ...
    1. [Smart AI Docs MCP](https://smart-ai.dev/continuedev/continue-docs-mcp)
    2. [Mintlify Technical Writing Rule](https://smart-ai.dev/mintlify/technical-writing-rule)
...
## What is the Smart AI Docs MCP?

<Card title="Smart AI Docs MCP" icon="circle-info">
  A Model Context Protocol server built with [Mintlify's MCP generation](https://www.mintlify.com/blog/generate-mcp-servers-for-your-docs) that enables semantic search across Smart AI documentation. [Learn more →](/reference/continue-mcp)
</Card>

The MCP helps you:
- **Find examples** from existing documentation
- **Maintain consistency** with established patterns
- **Source accurate information** about Smart AI features
...
Cookbooks show how to use Smart AI CLI with specific tools or services. Here's how to create one using the Smart AI Docs MCP:
...
<Steps>
  <Step title="Research Existing Cookbooks">
    ...
    **Prompt:**
    ```
    "Show me the structure of existing MCP cookbooks in the Smart AI docs.
  ...
  <Step title="Source Official Documentation">
    **Prompt:**
    ```
    "Using the Smart AI Docs MCP, find information about how GitHub MCP works.
    ...
    The agent will:
    - Search Smart AI docs for MCP patterns
  ...
  <Step title="Add to Navigation">
    **Prompt:**
    ```
    "Add my new github-mcp-smartai-cookbook.mdx to the docs.json navigation
...
<Info>
  **Pro Tip:** The agent uses the Smart AI Docs MCP to maintain consistency with existing cookbooks automatically.
</Info>
...
<Steps>
  ...
  <Step title="Make Targeted Updates">
    **Prompt:**
    ...
    to include information about the new Slack MCP server. Use the Smart AI
...
<Steps>
  <Step title="Research Similar Content">
    **Prompt:**
    ```
    "I want to create a guide for setting up Smart AI with Amazon Bedrock.
    Search the Smart AI docs for similar model provider setup guides and
  ...
  <Step title="Create the Guide">
    **Prompt:**
    ...
    Use the Smart AI Docs MCP to find accurate information about Smart AI's
...
**Prompt:**
```
"Create a cookbook for using Smart AI with PostgreSQL MCP. Follow the same
...
Use the Smart AI Docs MCP to find MCP configuration patterns and search the
...
**Prompt:**
```
"Create a cookbook showing how to use Smart AI to analyze Sentry errors.
...
**Prompt:**
```
"I want to create a cookbook for using Smart AI to work with OpenAPI specs.

Show how to:
1. Load OpenAPI specs into Smart AI's context
2. Generate API client code from specs
3. Create tests based on API endpoints
4. Update documentation when APIs change

Use the Smart AI Docs MCP to find how context providers work, then combine
...
<CardGroup cols={2}>
  <Card title="Multi-Source Research" icon="magnifying-glass">
    ```bash
    "Use the Smart AI Docs MCP to understand how agents
    work in Smart AI, then search the web for Anthropic's
    Computer Use MCP. Create a cookbook showing how to
    combine Smart AI agents with Computer Use for
    automated testing."
    ```
  </Card>
  ...
  <Card title="Cross-Reference Documentation" icon="link">
    ```bash
    "Find all mentions of MCP servers across Smart AI
  ...
  <Card title="Example Extraction" icon="code">
    ...
    configuration from the Smart AI docs. Format them
...
Add automated documentation checks to your PR workflow using the Smart AI Docs MCP agent:
...
jobs:
  check-docs:
    ...
    steps:
      ...
      - name: Install Smart AI CLI
        run: npm i -g @smartai/cli

      - name: Analyze Changes for Documentation Needs
        id: analyze
        env:
          SMARTAI_API_KEY: ${{ secrets.SMARTAI_API_KEY }}
        run: |
          ...
          # Use Smart AI agent to check if docs need updates
...
- [Smart AI Docs MCP Cookbook](/guides/smartai-docs-mcp-cookbook)

*This analysis was generated using the Smart AI Docs MCP agent.*
EOF
...
<Info>
  This workflow uses the Smart AI Docs MCP agent to analyze code changes and automatically comment on PRs when documentation updates are recommended.
</Info>
...
<Steps>
  ...
  <Step title="Publish to Smart AI Mission Control">
    Share your docs MCP on [Smart AI Mission Control](https://smart-ai.dev/new?type=mcp) so others can use it with Smart AI agents.
  </Step>
</Steps>

<Info>
  The [Smart AI Docs MCP](/reference/continue-mcp) itself was built this way!
</Info>
...
| Task | Prompt |
|:-----|:-------|
| **Find structure** | "Show me the structure of existing cookbooks in Smart AI docs" |
| **Create cookbook** | "Create a cookbook for [tool] MCP following the dlt cookbook structure" |
| **Update docs** | "Update [file] to include information about [feature], using Smart AI Docs MCP to find examples" |
| **Add navigation** | "Add [file] to docs.json under the [section] section" |
| **Check consistency** | "Review this file for consistency with other Smart AI documentation" |
| **Fix formatting** | "Review for Mintlify formatting issues and fix any problems" |
| **Extract examples** | "Find all examples of [topic] in Smart AI docs" |
| **Research feature** | "Use Smart AI Docs MCP to explain how [feature] works in Smart AI" |

---

## Resources

### Smart AI Documentation
- [Contributing Guide](/CONTRIBUTING) - Setup and submission process
- [Smart AI Docs MCP Reference](/reference/continue-mcp) - MCP server details
...
<CardGroup cols={2}>
  ...
  <Card title="Use Docs Agent" icon="robot" href="https://smart-ai.dev/continuedev/docs-mintlify">
