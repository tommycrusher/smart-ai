---
title: "Contributing to Smart AI Documentation"
sidebarTitle: "Docs Contributions"
description: "Welcome to the Smart AI documentation! We're excited that you want to contribute. This guide will help you get started with our documentation workflow and tools."
---
...
1. **Fork and clone the repository**
   ...
   gh repo fork tommycrusher/smart-ai
   cd continue/docs
   ```
...
<Steps>
  <Step title="Go to GitHub Discussions">
    Visit the [Smart AI GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) page.
  </Step>
  ...
  <Step title="Provide detailed information">
    ...
    - Your environment (OS, IDE, Smart AI version)
  </Step>
</Steps>
...
<Info>
  ...
  **Important**: All issues should start as discussions. The Smart AI team will determine if and when a discussion should be escalated to a GitHub issue.
  
</Info>

The Smart AI team will review discussions and may:
...
## 🤖 AI-Powered Documentation with Smart AI

We strongly encourage using Smart AI's AI assistance to maintain consistency and quality in our documentation. Here are three ways to set this up:
...
<Steps>
  <Step title="Install the agent from Smart AI Mission Control">
    Visit [the Docs Assistant - Mintlify in Mission Control](https://smart-ai.dev/continuedev/docs-mintlify) and click "Install" to add it to your Smart AI setup. This agent comes pre-configured with all our documentation standards.

    <Info>
    Learn more about Smart AI Configs in our [config documentation](/guides/understanding-configs).
    </Info>
  </Step>
  ...
  <Step title="Use the agent">
    <Tabs>
      <Tab title="Command Line">
        ```bash
        # Install the Smart AI CLI if you haven't already
        npm install -g @smartai/cli
        
        # Use the agent from the command line
        cn "Create a new guide for using the Smart AI CLI with Linear" --config tommycrusher/docs-mintlify
        ```
      </Tab>
      
      <Tab title="IDE">
        1. Open Smart AI in your IDE
        2. Select the "Docs Assistant - Mintlify" agent from the model dropdown
        3. Ask it to help you create or edit documentation
        
        Example prompts:
        - "Create a new guide for using the Smart AI CLI with Linear"
...
<Steps>
  ...
  <Step title="Add the Smart AI Docs MCP">
    Install from Smart AI Mission Control: https://smart-ai.dev/tommycrusher/smart-ai-docs-mcp
    
    This MCP provides context about Smart AI's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from Smart AI Mission Control: https://smart-ai.dev/mintlify/technical-writing-rule
...
2. Add frontmatter:
   ...
   ---
   ```
3. Use the Smart AI agent to help format your content
...
1. Use the Smart AI agent with prompts like:
...
3. **Format check**: Use the Smart AI agent to validate Mintlify formatting
...
- **Use the Smart AI agent**: It knows our documentation standards and will save you time
...
- **Start a Discussion**: Use [GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) for documentation issues, suggestions, or questions
- **Smart AI agent questions**: Check the [Smart AI Mission Control page](https://smart-ai.dev/continuedev/docs-mintlify)
- **GitHub Discussions**: Join the [GitHub Discussions](https://github.com/tommycrusher/smart-ai/discussions) for community help
- **Existing docs**: Review similar pages for formatting examples
---

Thank you for contributing to Smart AI! Your efforts help make our documentation better for everyone. To learn more about contributing to other parts of the project, check out our [main CONTRIBUTING guide](https://github.com/tommycrusher/smart-ai/blob/main/CONTRIBUTING.md) 🎉
