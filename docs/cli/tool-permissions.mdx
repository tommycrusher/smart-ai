...
Persistent permissions are stored in `~/.smart-ai/permissions.yaml`. This file is updated when you choose "Smart AI + don't ask again" in the TUI approval prompt.

```yaml
# ~/.smart-ai/permissions.yaml
allow:
  - Read(*)
  - Write(**/*.ts)
